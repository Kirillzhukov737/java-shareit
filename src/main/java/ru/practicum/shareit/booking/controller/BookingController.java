...
public class BookingController {
    ...
    public BookingDto setApproveStatus(@RequestHeader(Constants.X_SHARER_USER_ID) Long ownerId,
    ...
    public List<BookingDto> getBookingsOfOwner(@RequestHeader(Constants.X_SHARER_USER_ID) Long ownerId,
    ...
    public BookingDto getBookingById(@RequestHeader(Constants.X_SHARER_USER_ID) Long userId,
                                     @PathVariable Long bookingId) {
    ...
    @GetMapping("/bookings")
    public List<BookingDto> getBookingsOfUser(@RequestHeader(Constants.X_SHARER_USER_ID) Long ownerId,
                                              @RequestParam(required = false, defaultValue = "ALL") String state) {
