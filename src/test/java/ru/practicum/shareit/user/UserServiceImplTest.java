...
class UserServiceImplTest {
    ...
    void updateNonExistingUser() {
        ...
        assertEquals("unable to update user: user not found",
    ...
    void updateOnAlreadyExistingUser() {
        ...
        UserInputDto user2Up = UserInputDto.builder()
                ...
                .email("user@user.com")
                .build();
        ObjectAlreadyExists exception = assertThrows(ObjectAlreadyExists.class,
                () -> userService.updateUser(user2Up, userId));
